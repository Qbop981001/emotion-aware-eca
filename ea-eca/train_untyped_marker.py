...
ckpt_dir = 'checkpoint__untyped_marker'
...
def main(fold_id,train_loader,valid_loader,real_valid_loader):
    ...
    with open(os.path.join(ckpt_dir,'fold'+str(fold_id)+'results2e.txt'),'w') as f:
        for i in out_strs:
            f.write(i+'\n')
...
if __name__ == '__main__':
    ...
    for fold_id in range(1, 11):
        ...
        # print(best_str)
        # with open(os.path.join(ckpt_dir,'fold'+str(fold_id)+'results2e.txt'), 'a') as f:
        #     f.write(best_str+'\n')
    ...
    # with open(ckpt_dir+'/final.txt', 'w') as f:
