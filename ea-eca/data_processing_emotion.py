        ...
        for doc in js:
            ...
            for clause in clauses:
                if clause['emotion_category'] == 'null':
                    ...
                    sentiments.append(1)
                if '&' in clause['emotion_category']:  # multiple emotion in one clause, omit this at current time
                    # print(doc)
...
def get_doc_info(fold_id):
    ...
    with open(filename, encoding='utf-8') as f:
        ...
        for doc in js:
            ...
            docs_lens.append(doc["doc_len"])

    return docs_ids, docs_lens
