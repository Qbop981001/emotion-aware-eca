...
def main(fold_id,train_loader,valid_loader):
    ...
    for epoch in range(EPOCH):
        ...
        out_str = f"p = {p}, r = {r}, f1 = {f1}  ece = {ece}    epoch_time: {epoch_time}s"
        print(out_str)
...
if __name__ == '__main__':
    ...
    for fold_id in range(1, 11):
        ...
        best_str = f"best f1: {metric_ece[0]}, in epoch {metric_ece[1]}; best acc: {metric_ece[2]}, in epoch {metric_ece[3]}"
        print(best_str)
    ...
    print(f"average_f1: {average_f1}, average_acc: {average_acc}")
    with open(ckpt_dir+'/final.txt', 'w') as f:
        f.write(f"average_f1: {average_f1}, average_acc: {average_acc}")
